...
<Box>
The invalid code above looks like this in the browser. There is no difference in the browser of the broken code as the correct code. Only until we add more content to the page may we see the effects of our error.
