import { FullScreenCode, Notes } from 'mdx-deck'
export { default as theme } from '@handbook/deck/theme'
import { OurSplit as Split } from '@handbook/deck/OurSplit'
import Image from '@handbook/deck/Image'
...
<Image src={require("./assets/jason-plain.png")} />
...
<Image src={require("./assets/jason-paragraph.png")} />
...
<Image src={require("./assets/jason-strong.png")} />
</Split>
...
<Image src={require("./assets/jason-invalid.png")} />
...
<Image src={require("./assets/code-01.png")} />
