...
When we add a migration dotnet is comparing several things. It is comparing the
...
`Actors`. dotnet then considers what it has in it's `design`. Since this is our
...
The final file `SuncoastMoviesContextModelSnapshot.cs` is dotnet's overall view
of the design of your database structure. This is the structure dotnet will
compare against when we make any future migrations. This file should **not**
need to be edited.
